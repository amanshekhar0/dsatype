  ...
  return (
    <div className="h-full">
      <textarea
        ...
        className="w-full h-full bg-gray-800 rounded-lg border border-gray-700 p-4 font-mono text-sm resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
        spellCheck={false}
        autoCorrect="off"
        autoCapitalize="off"
      />
