...
import { EyeIcon, EyeOffIcon, LogInIcon, ArrowLeftIcon } from 'lucide-react';
...
export const LoginPage = () => {
  ...
  useSEO({
    title: 'Sign In',
    description: 'Sign in to CodeType to track your coding typing progress, streaks, and achievements.',
    canonicalPath: '/login',
  });
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm animate-fade-up">
        ...
        <div className="text-center mb-7">
          ...
          <p className="text-muted-foreground mt-1.5 text-sm">Sign in to continue your streak</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-background/60 border border-border rounded-lg px-3 py-2.5 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/60 focus:border-primary/60 transition-all"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-background/60 border border-border rounded-lg px-3 py-2.5 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/60 focus:border-primary/60 transition-all pr-10"
                  placeholder="••••••••"
                />
                <button
                  type="button"
